...
--- Cancels a timer previously created with event.timer.
--- @param timerId number # a timer ID as returned by event.timer.
--- @return boolean # Returns: true if the timer was stopped, false if there was no timer with the specified ID.
